...
public class LocationServicesRouteBuilder extends SpringRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        .process(exchange -> {
        	...
        	passenger.setLatitude("33.969601");
        	passenger.setLongitude("-84.100033");
        	passenger.setLastName("Eloundou");
        	passenger.setFirstName("Cyrille");
        	passenger.setAge("36");
        	passenger.setAddress(address);
			exchange.getIn().setBody(passenger);
		});
